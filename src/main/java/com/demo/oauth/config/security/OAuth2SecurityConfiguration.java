...
import com.demo.oauth.common.security.UserDetailsService;
...
//				.withUser("bob").password("abc123").roles("USER");
	...
	public TokenStoreUserApprovalHandler userApprovalHandler(TokenStore tokenStore){
		...
		//handler.setClientDetailsService(getClientDetailsService());
		return handler;
	}
	...
	public static void main(String[] args) {
		System.out.println(new Md5PasswordEncoder().encodePassword("abc123", ""));
	}
